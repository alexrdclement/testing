...
```toml
[versions]
maindispatcher-extension = "0.0.13"
...
```kotlin
testImplementation("com.alexrdclement.testing:maindispatcher-extension:0.0.13")
```
...
```kotlin
dependencies {
    testImplementation("com.alexrdclement.testing:maindispatcher-rule:0.0.13")
}
```
