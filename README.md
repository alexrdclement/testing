...
```toml
[versions]
maindispatcher-extension = "0.0.25"
...
```kotlin
testImplementation("com.alexrdclement.testing:maindispatcher-extension:0.0.25")
```
...
```kotlin
dependencies {
    testImplementation("com.alexrdclement.testing:maindispatcher-rule:0.0.25")
}
```
